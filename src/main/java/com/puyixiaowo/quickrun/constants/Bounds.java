...
public class Bounds {
	...
	public static final Rectangle edit_shorcut_label_text_icon = new Rectangle(12, 126, 64, 30);
	public static final Rectangle edit_shorcut_filed_text_icon = new Rectangle(80, 126, 240, 30);

	public static final Rectangle edit_shorcut_button_get_icon = new Rectangle(324, 126, 30, 30);
	public static final Rectangle edit_shorcut_button_save = new Rectangle(274, 168, 80, 30);
}
